...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func initializeS3() {
        let poolId = "us-west-2:a0121a58-c488-4c92-858e-0a635820e5b7" // 3-1
        let credentialsProvider = AWSCognitoCredentialsProvider(regionType: .USWest2, identityPoolId: poolId)//3-2
    ...
    lazy var persistentContainer: NSPersistentContainer = {
      ...
      let container = NSPersistentContainer(name: "ModeloArticulos")
